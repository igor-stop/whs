...
gulp.task('watch', ['sass', 'libs', 'browser-sync'], function() {
	gulp.watch('app/header.scss', ['headersass']).on('change', browserSync.reload);;
...
gulp.task('build', ['removedist', 'buildhtml', 'svgmin', 'imagemin', 'sass', 'libs'], function() {
	...
	var buildCss = gulp.src('app/css/*.min.css').pipe(gulp.dest('dist/css'));

	var buildHeaderCss = gulp.src('app/header.min.css').pipe(gulp.dest('dist'));
