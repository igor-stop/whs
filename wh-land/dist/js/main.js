...
document.addEventListener('DOMContentLoaded', function () {
  if (document.querySelector('.mtFedback-carousel')) {
    setTimeout(function () {
      ...
      var slides = document.querySelectorAll('.swiper-slide '); //slide-height

      mySwpr.on('slideChange', function () {
        slides.forEach(function (slide) {
          var opnBtn = slide.querySelector('.read-more');
          var clsBtn = slide.querySelector('.read-less');
          var textWrap = slide.querySelector('.mtFedback__text');
